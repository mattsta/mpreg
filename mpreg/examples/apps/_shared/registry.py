...
APPS: tuple[ExampleApp, ...] = (
    ...
    _app(
        ...
        "Queue Ack/Receive Lab",
        AppLevel.L1,
        "Poll receive + explicit acknowledge + broadcast/FNF.",
        ("queue",),
        kind="plane",
    ),
    _app(
        "pubsub_client_backlog",
        "PubSub Client Backlog",
        AppLevel.L1,
        "MPREGPubSubClient wire path + get_backlog.",
        ("pubsub", "client"),
        kind="plane",
    ),
    _app(
        "cache_replication_geo",
        "Cache Replication Geo",
        AppLevel.L1,
        "Geo hints, replication policy, L2, pattern invalidate.",
        ("cache", "persistence"),
        kind="plane",
    ),
    _app(
        ...
        "Fabric Policy Modes",
        AppLevel.L1,
        "Strict/explicit federation + catalog + link-state.",
        ("fabric",),
        kind="plane",
    ),
    _app(
        ...
        "RPC Concurrency Lab",
        AppLevel.L1,
        "Concurrent gather calls + M3 policy + routing_topic.",
        ("rpc", "client"),
        kind="plane",
    ),
    _app(
        ...
        "Cluster Map Catalog",
        AppLevel.L1,
        "refresh_cluster_map + catalog_query + summary_query.",
        ("client", "discovery"),
        kind="plane",
    ),
    _app(
        ...
        "Mon Logging JSON",
        AppLevel.L1,
        "configure_logging json_logs + correlation/health.",
        ("monitoring",),
        kind="plane",
    ),
    _app(
        ...
        "Chaos Crash Recover",
        AppLevel.L1,
        "FaultInjector crash/recover + partition compose.",
        ("chaos",),
        kind="plane",
    ),
    _app(
        "tx_circuit_breaker_lab",
        "TX Circuit Breaker Lab",
        AppLevel.L1,
    ...
    _app(
        ...
        "NS Engine Direct",
        AppLevel.L1,
        "In-process NamespacePolicyEngine owner/viewer gates.",
        ("namespace",),
        kind="plane",
    ),
    _app(
