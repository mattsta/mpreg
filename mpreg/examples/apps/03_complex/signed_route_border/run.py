...
from mpreg.examples.apps._shared.runtime import app_run, scenario, ensure, ok, run_with_servers, step
...
async def main() -> None:
    with app_run("signed_route_border", "Signed Route Border", level="L3"):
        with scenario("primary drill", "fabric.route_security", "fabric.route_policy", "fabric.route_keys", "fabric.strict"):
