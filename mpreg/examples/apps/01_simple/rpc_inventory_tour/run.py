        ...
        async def _run(servers: list[MPREGServer]) -> None:
            ...
            async with MPREGClientAPI(url) as client:
                with scenario(
                    ...
                    out = await client.call("alpha", 1, locs=frozenset(["inv"]))
                ...
                with scenario(
                    ...
                    desc2 = await client.rpc_describe(RpcDescribeRequest(mode="auto"))
                ...
                with scenario(
                    ...
                    if hasattr(client, "rpc_list"):
                        ...
                        out = await client.call("beta", "x", locs=frozenset(["inv"]))
                        ensure(out == "b:x", out)
                ...
                with scenario(
                    ...
                    try:
                        filtered = await client.rpc_describe(
                            RpcDescribeRequest(mode="local", function_name="alpha")
                        )
