...
async def main() -> None:
    with app_run(
        ...
        with scenario("golden signals catalog", "mon.slo", "mon.golden_signals"):
            ...
            ensure("mpreg_rpc_latency_ms" in latency.prometheus_metric, latency.prometheus_metric)
        ...
        with scenario("inject preference order", "mon.trace_context"):
            ...
            # explicit arg wins over existing metadata
            ...
            # existing wins when no explicit / bind
