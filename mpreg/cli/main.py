...
def config_check(
    ...
    explain_guide = {
        ...
        "strong_cache": (
            ...
            "Prometheus mpreg_strong_abort_fail_peers), or "
            "`mpreg doctor --strong --format json` strong rows "
            "(same JSON-native types via strong_doctor_json_residual_fields: "
            "abort_fail_peer_count int, last_abort_fail_peers list, "
            "last_abort_fail_op_id str, residual_ops_hint str), then "
