...
class EmailNotificationBackend:
    ...
    async def send_notification(
        ...
        sender = channel.config.get("sender")
        recipients = channel.config.get("recipients") or channel.config.get("recipient")
        if not sender or not recipients:
            raise ValueError("sender and recipients required for email notifications")
