...
class TestTopicExchange:
    ...
    def test_topic_advertisement(self):
        ...
        with topic_exchange_context() as (exchange, server_url):
            # Add subscriptions
            ...
            assert ad.server_url == server_url
...
class TestIntegrationScenarios:
    ...
    def test_ecommerce_event_routing(self):
        ...
        with topic_exchange_context("ecommerce_cluster") as (exchange, _):
            ...
            events = [
                ...
                (
                    "user.789.registered",
                    {"user_id": "789", "email": "user@example.com"},
                ),
            ...
            assert (
                service_notifications["inventory_service"] == 2
            )  # Created and cancelled
            assert (
                service_notifications["email_service"] == 2
            )  # Completed and registered

    def test_iot_sensor_data_routing(self):
        """Test IoT sensor data routing scenario."""
        with topic_exchange_context("iot_cluster") as (exchange, _):
            ...
            subscriptions = [
                ...
                PubSubSubscription(
                    ...
                    patterns=(
                        TopicPattern(pattern="sensor.room_a.#", exact_match=False),
                    ),
    ...
    def test_high_frequency_trading_scenario(self):
        ...
        with topic_exchange_context("trading_cluster") as (exchange, _):
            ...
            subscriptions = [
                ...
                PubSubSubscription(
                    ...
                    patterns=(
                        TopicPattern(
                            pattern="market.crypto.btc.price", exact_match=True
                        ),
                    ),
                ...
                PubSubSubscription(
                    ...
                    patterns=(
                        TopicPattern(pattern="market.crypto.#", exact_match=False),
                    ),
