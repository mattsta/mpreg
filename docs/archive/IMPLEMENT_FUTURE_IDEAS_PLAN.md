...
**Version**: 1.0.0
**Status**: Archived backlog (superseded by `docs/UNIFIED_UNIFICATION_PLAN.md`)

NOTE
This document is a long-term backlog and predates fabric unification. Any
future work should be re-evaluated and re-prioritized in the unified plan.
