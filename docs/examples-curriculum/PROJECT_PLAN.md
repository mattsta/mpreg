...
| **J4** | Residual apps: discovery*resolver_audit, queue_federation_lab, transport*\*, blockchain_message_lab | [x]    |
...
| F12 | mTLS                 | No turnkey local-cert path                                                                           | Info     | `generate_dev_tls_material` + tls\_\* settings | `tls_dev_handshake` **FIXED J**                                       |
...
| R3  | CAP    | MPREGClient: namespace*status/policy*\* + discovery_access_audit | [x]    |
