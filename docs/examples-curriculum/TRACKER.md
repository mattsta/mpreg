...
| P2 MPREGClient discovery surface | [x]    | list*peers/cluster_map/catalog*\*/summary_query |
...
| R0 append plan                                    | [x]    |
| R1 unified dns\_\*                                | [x]    |
| R2 unified summary*watch + resolver*\*            | [x]    |
| R3 unified namespace\_\* + discovery_access_audit | [x]    |
