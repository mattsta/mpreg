...
> **0.3.1 Production Hardening:** `docs/RELEASE_0_3_1_PRODUCTION_HARDENING_ARCHITECTURE.md` (broader CI, lint bar, SUPPORT.md).
...
(`uv run mpreg distlab`). STRONG and shared-audit adapters let the
