...
| T20 config-check groups | `test_config_check_*_honesty_warnings`, strong*cache/shared_audit groups | support ops |
...
| T24 prom cap gauges | `mpreg_strong_cap*_`/`mpreg*shared_audit_cap*_`endpoint test | support ops |
| T24 honesty alerts |`test*t24_prometheus_alerts_include_honesty_rules`| support ops |
...
| T39 retry prom |`mpreg_strong_retry_abort*\*\_total`series | support ops |
